...
ALTER TABLE instance_settings
    ...
    ADD COLUMN IF NOT EXISTS backup_description TEXT NOT NULL DEFAULT 'Dockfin database',
    ADD COLUMN IF NOT EXISTS backup_db_user TEXT NOT NULL DEFAULT 'dockfin',
    ADD COLUMN IF NOT EXISTS backup_db_name TEXT NOT NULL DEFAULT 'dockfin',
